defmodule Pxblog.UserControllerTest do
  ...
  alias Pxblog.User
  @valid_create_attrs %{email: "test@email.com", password: "testing123", password_confirmation: "testing123", username: "TestUser"}
  @valid_attrs %{email: "test@email.com", username: "TestUser"}
  @invalid_attrs %{}
